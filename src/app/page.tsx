    ...
    <>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Automação de IA para <span className="text-primary">Clínicas de Estética</span>
            </h1>
      ...
      <Section background="light" className="py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">Soluções Completas para sua Clínica</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold mb-2">NeoCalendar</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold mb-2">NeoFollow</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold mb-2">NeoAI</h3>
            <p className="text-gray-600 mb-4">
